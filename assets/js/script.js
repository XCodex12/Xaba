...
const images = [
    ...
    './assets/images/Me.jpg' // Replace with the path to your second image
];
...
setInterval(() => {
    ...
    avatarImage.classList.add('hidden'); // Fade out the current image

    setTimeout(() => {
        avatarImage.src = images[currentIndex]; // Change the image source
        avatarImage.classList.remove('hidden'); // Fade in the new image
    }, 500); // Match this with the CSS transition duration
}, 5700); // Change image every 5.7 seconds
